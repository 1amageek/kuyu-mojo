...
| The canonical Metal bundle is reproducible and relocatable | Two independent builds produced receipt `5e3ea40d3236289a757e6d063cbe8a2f8bde406cb82537c8338610b81283a6ab` and bundle `0159c5a65dc14324bcbb5c09b2208857feb242d431df79a420d578d6a8837303`; original and relocated `env -i` executions each passed 11 graphs × 2 scenarios | Canonical graph execution, transfer, synchronization, runtime closure, and relocation are proven on Apple M4 Max; production worker lifecycle and training remain separate gates |
...
|---|---|---|
| Receipt | Canonical Metal object and four-library MAX closure verified as receipt `5e3ea40d…` | Native ELF object/shared-library receipt pending |
| Toolchain | Metal Toolchain `v27.1.5237.12` present and used | Native Modular/MAX and CUDA toolchain present |
| Build | Exact `metal:4` bundle `0159c5a6…` links all declared MAX dylibs | Native AArch64 worker links declared MAX shared libraries |
