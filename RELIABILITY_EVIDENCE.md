...
| The checked-in ABI artifact matches the source graph | `swift package mojo inspect --target KuyuMojoDynamics --format json` | One binding; input graph `17ccc1dafcd1a39fe839f86cd62aad3c592f740eac953e1dc288834373f29d4d`; artifact `bdece09559ebb25fc58e68245957ed38f636140be8afe5e2914e2c73a6aff04b` |
...
Mojo `1.0.0 (ed45d567)`. This evidence covers macOS arm64 CPU Float64 only. It
does not claim Metal, CUDA, native Jetson, sanitizer, learning, or HIL
qualification.
